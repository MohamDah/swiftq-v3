...
export default function QueueEntryCard({ customer }: { customer: Customer }) {
  ...
  const getWaitTimeDisplay = () => customer.estimatedWaitTime + ' minutes'
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <div className="flex flex-col items-start mt-1">
              ...
              <span
                className={`inline-flex items-center px-2 py-0.5 mt-1 rounded-full text-xs font-medium shadow-md shadow-black/25 ${
